...
public class SpecialPirate extends PirateShip{
	int prevState;

	/*
	 *Constructor for special Pirate.
	*/
	SpecialPirate(Image shipImage, Point shipLoc){
		OceanMap oceanMap = OceanMap.getInstance();
		this.shipView = new ImageView(shipImage);
		this.sailStrategy = new SpecialPirateSail();
		this.decorator = new SailingDecorator(this.sailStrategy);
