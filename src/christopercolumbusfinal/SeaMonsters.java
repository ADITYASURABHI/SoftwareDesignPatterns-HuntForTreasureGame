...
public class SeaMonsters{
	...
	************************************************************/
	public SeaMonsters(MonsterGroup monsterGroup, Point monsterPoint) {
		this.monsterGroup = monsterGroup;
		this.monsterPoint = monsterPoint;
		OceanMap oceanMap = OceanMap.getInstance();
		Image monsterImage = new Image("/seaMonsters.jpg",oceanMap.getScale(), oceanMap.getScale(), true,true);
